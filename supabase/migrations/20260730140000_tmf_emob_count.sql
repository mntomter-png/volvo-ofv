-- Utvid TMF-markedsdata med EMOB-telling for drivlinje-split (ICE vs elektrisk).
...
returns table(month date, pabygg text, count int, volvo_count int, emob_count int)
