-- Potensial: Volvo-sterke påbygg defineres nasjonalt (YTD), ikke per distrikt.
-- Region/distrikt filtrerer kun kontoene i handlingslisten (scoped), ellers blir
-- listen tom for små distrikt (f.eks. Buskerud: ingen påbygg ≥20 enheter lokalt).
