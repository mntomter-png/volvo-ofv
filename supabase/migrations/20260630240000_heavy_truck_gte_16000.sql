-- Align heavy-truck weight filter with OFV: >= 16000 kg (not > 16000).
...
-- Dashboard views (tunge lastebiler >= 16t).
...
-- Dashboard RPC (region/påbygg-signatur fra disp_chassis-migrasjonen)
