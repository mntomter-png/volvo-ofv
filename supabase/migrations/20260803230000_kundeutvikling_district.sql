-- Kundeutvikling: p_district (Volvo-distrikt via ofv_district_from_postal / sales_district).
...
as $$
  ...
  scoped as (
    ...
    where r.transaction_type_id = '10'
      ...
      and (
        p_district is null
        or public.ofv_district_from_postal(r.primary_user_postal_code) = p_district
      )
