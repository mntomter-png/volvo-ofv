-- PKK: distriktsfilter (sales_district fra brukerens postnummer) ved siden av region.

drop function if exists public.pop_pkk_summary(int, int, int, boolean, text, boolean, text, text);
drop function if exists public.pop_pkk_customers(int, int, int, boolean, text, boolean, text, text);
drop function if exists public.pop_pkk_owner_vehicles(text, int, int, boolean, text, text, int, text);
...
as $$
  ...
  base as (
    select owner_key,
           ...
           max(sales_district) as sales_district,
...
grant execute on function public.pop_pkk_summary(int, text, int, int, boolean, text, boolean, text, text) to authenticated;
grant execute on function public.pop_pkk_customers(int, text, int, int, boolean, text, boolean, text, text) to authenticated;
