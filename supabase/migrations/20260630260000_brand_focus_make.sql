-- Parameteriser fokusmerke (standard Volvo) i volvo_count-aggregeringer.
...
create function public.dash_registrations_by_month(
  p_segment text default null,
  p_region int default null,
  p_pabygg text default null,
  p_focus_make text default 'Volvo'
...
grant execute on function public.reg_summary_by_month(int, text, text, int, int, text, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_region(int, text, text, int, int, text, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_hp(int, text, text, int, int, text, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_fuel(int, text, text, int, int, int, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_pabygg(int, text, text, int, int, int, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_fleet_owners(int, text, int, int, text, text, int, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_disp(int, text, text, int, int, int, text, text, text, date, date, text) to authenticated;
grant execute on function public.reg_summary_by_chassis(int, text, text, int, int, int, text, text, int, date, date, text) to authenticated;
grant execute on function public.pop_summary_by_segment(text, text, int, int, text, text, int, text, text, text) to authenticated;
grant execute on function public.pop_summary_by_region(text, text, int, text, text, int, text, text, text) to authenticated;
grant execute on function public.pop_summary_by_fuel(text, text, int, int, text, int, text, text, text) to authenticated;
grant execute on function public.dash_registrations_by_month(text, int, text, text) to authenticated;
