  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Overstyr prognosen per segment. Justering i % legges på toppen av SSB/scenario.
          Volvo-andel kan overstyres for neste års estimat.
        </CardDescription>
      </CardHeader>
              ...
              <tr key={segment} className="border-b border-border/50">
                ...
                <td className="py-3 pr-4">
                  <Input
                    ...
                    onChange={(event) => updateAdjustment(segment, event.target.value)}
                  />
                </td>
                <td className="py-3">
                  <Input
                    ...
                    onChange={(event) => updateVolvoShare(segment, event.target.value)}
                  />
                </td>
              </tr>
            ))}
